...
@section('content')
    <div class="mobContainer mobile" >
        <div style="text-align: center;"> <div class="mx-auto my-3" style="width: 100px; height: 100px; border-radius: 50%; overflow: hidden; text-align: center "><img src="{{url("images/uploads/$intern->profile_photo")}}" style="width: 100px;" alt=""></div> </div>

        <div class="d-flex justify-content-center align-items-start">
            <p style="font-size:23px" class="rDivP mb-0 me-2" >{{$user->name}}</p>
            @if(!$sessions_meta)
                <i class="fa mb-auto fa-xmark text-danger"></i>
            @elseif($sessions_meta->paid=='false')
                <i class="fa mb-auto fa-stop-circle text-warning"></i>
            @else
                <i class="fa mb-auto fa-check-circle text-success"></i>

            @endif
        </div>
        <div><p class="rDivP" style="font-size: 18px;">عميلة</p></div>
        @if(!$sessions_meta)
            <h3 class="text-center my-2 text-white">لم تشتركي بعد</h3>
        @else
            @if($sessions_meta->paid=='false')
            <h3 class="text-center my-2 text-white">لم تدفعي اشتراكك</h3>
            @endif
        ...
        <div class="row gap-1 justify-content-center">
            <div class=" col-10">
                <div class=" mobEvalDiv row">
                    <div class="col-10">
                        <p class="mobEval"> باقة ال {{$package->sessions_number}} حصص</p>
                        <p class="mobCval">{{$subscription->name}} </p>
                    </div>
...
{{--                </div>--}}
                ...
                <div class="row justify-content-center " >
                    @if(count($announcements)==0)
                     <p class="text-sm text-center text-light">لا يوجد اخبار</p>
                    @else
                        @foreach($announcements as $a)
                        <div class="col-10">
                            <div class="noteDiv">
                                <div class="text-{{$a->type}}" style="text-align: center; font-weight:bold"><p>هام جدا</p></div>
                                <div style="text-align: center; font-weight:bold; color:#9098A3"><p>{{$a->announcmenet}}   </p></div>
                            </div>
                        </div>
                        @endforeach
                    @endif
    ...
    <div class="container datacontainer">
        <div class="row">
            ...
            @else
                    ...
                    <div class="col">
                        @if($sessions_meta->paid=='false')
                            <h3 class="text-center mb-3 text-white">لم تدفعي اشتراكك</h3>
                        @endif
...
{{--                        </div>--}}
                        ...
                        <div class="row justify-content-center " >
                            <p class="title2">أخر الأخبار</p>

                        @if(count($announcements)==0)
                            <p class="text-xs text-center my-3 text-light">لا يوجد اخبار</p>
                        @else
                            @foreach($announcements as $a)
                                <div class="col-sm">
                                    <div class="noteDiv">
            ...
            <div class="col-sm-4 col-lg-3 col-md-4 datadivcard bigDiv w-l" id="sideDiv">
                <div style="text-align: center;">
                    <div class="mx-auto my-3" style="width: 100px; height: 100px; border-radius: 50%; overflow: hidden; text-align: center ">
                        <img src="{{url("images/uploads/$intern->profile_photo")}}" style="width: 100px;" alt="">
                    </div>
                </div>

                <div class="d-flex justify-content-center align-items-start">
                    <p class="rDivP mb-0 me-2" >{{$user->name}}</p>
                    @if(!$sessions_meta)
                    <i class="fa mb-auto fa-xmark text-danger"></i>
                    @elseif($sessions_meta->paid=='false')
                    <i class="fa mb-auto fa-stop-circle text-warning"></i>
                ...
                <div class="row">
                    ...
                    <div class=" col-sm-7 col-lg-8 col-md-8">
                        <p class="rDivP"> باقة ال {{$package->sessions_number}} حصص</p>
                        <p class="rDivP" style="display: block;color: #DD2E2E">{{$subscription->name}} </p>
                    </div>
                ...
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div class=" col-sm-7 col-lg-8 col-md-8">
                        <p class="rDivP" style="    position: relative;top: 7px;"><a href="{{route("waintern.profile.editform")}}" class="link-dark link">عدلي بيناتك </a></p>
                    </div>
