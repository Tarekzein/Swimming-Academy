    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-lg-12 col-md-6">
                <form method="post" enctype="multipart/form-data" action="{{route("captain.profileEdit",$user->id)}}">
                <div class="card">
                    <div class="card-header text-center ">
                        <div class="avatar-group">
                            <img class="avatar shadow  avatar-xxl mt-n6 mx-auto" src="{{url("images/uploads/$captain->profile_photo")}}" alt="">
...
{{--                                    <label for="studyfield" class="form-label text-md-end">{{ __('Study field') }}</label>--}}
                                    ...
                                    <input id="studyfield" placeholder="Study field" type="text" value="{{$captain->study_field}}" class="form-control" name="study_field" required >
                                </div>
                            </div>
                        </div>
...
{{--                                    <label for="current_employer" class="form-label text-md-end">{{ __("Current Employer") }}</label>--}}
                                    ...
                                    <input id="current_employer" placeholder="Current Employer" type="text" value="{{$captain->current_employer}}" class="form-control" name="current_employer" required >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3">
{{--                                    <label for="previous_experience" class="form-label text-md-end">{{ __("Previous Experience") }}</label>--}}
                                    ...
                                    <input id="previous_experience" placeholder="Previous Experience" type="text" value="{{$captain->previous_experience}}" class="form-control" name="previous_experience" required >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row px-5">
                            ...
                            <div class="col-lg-4 align-items-center col-md-2">
                                <span>Previous: </span>
                                <a href="{{url("images/uploads/".$captain->personal_id)}}" target="_blank"><img class="avatar-lg" src="{{url("images/uploads/".$captain->personal_id)}}" alt="no photo"></a>
                            </div>
                        ...
                        <div class="row px-5">
                            ...
                            <div class="col-lg-4 align-items-center col-md-2">
                                <span>Previous: </span>
                                <a href="{{url("images/uploads/".$captain->rescue_certificate)}}" target="_blank"><img class="avatar-lg" src="{{url("images/uploads/".$captain->rescue_certificate)}}" alt="no photo"></a>
                            </div>
                        ...
                        <div class="row px-5">
                            ...
                            <div class="col-lg-4 align-items-center col-md-2">
                                <span>Previous: </span>
                                <a href="{{url("images/uploads/".$captain->rescue_card)}}" target="_blank"><img class="avatar-lg" src="{{url("images/uploads/".$captain->rescue_card)}}" alt="no photo"></a>
                            </div>
