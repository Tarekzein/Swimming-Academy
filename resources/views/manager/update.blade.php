...
@section("content")
    ...
    <h1>Update Manager Form</h1>
        ...
        <form method="post" action="{{route("manager.profile.update",$user->id)}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="studyfield" type="text" value="{{$manager->study_field}}" class="form-control" name="study_field" required >
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="current_employer" type="text" value="{{$manager->current_employer}}" class="form-control" name="current_employer" required >
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="previous_experience" type="text" value="{{$manager->previous_experience}}" class="form-control" name="previous_experience" required >
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    <span>Previous: </span>
                    <img width="150px" src="{{url("images/uploads/".$manager->profile_photo)}}" alt="">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    <span>Previous: </span>
                    <img width="150px" src="{{url("images/uploads/".$manager->personal_id)}}" alt="">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    <span>Previous: </span>
                    <img width="150px" src="{{url("images/uploads/".$manager->facility_receipt)}}" alt="">
                </div>
            </div>
