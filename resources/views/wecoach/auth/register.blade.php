    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('weregister') }}">
                        @csrf
                        <input id="academyID" name="academyID" value="1" hidden >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="whatsapp" type="text" class="whatsapp" name="whatsapp" required >
                            </div>
                        </div>
