<div class="row">
    <nav class="navbar pe-2 nav-fill navbar1 navbar-expand-sm colornav">
        <a class="navbar-brand" href="{{route("wecoach")}}">
            <img src="{{url("images/wecoach/_Path_.png")}}" alt="" class="imagi">
        </a>
        <div class="navbar-collapse col-sm-3" id="navbarSupportedContent">
            <ul class="navbar-nav linkS" >
                <li class="nav-item">
                    <a class="nav-link" href="{{route("wecoach")}}">الرئيسيه</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">الخدمات</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " aria-current="page" href="{{route("wecoach.products")}}">منتجاتنا</a>
                </li>
                <!-- Authentication Links -->
                @guest
                    @if (Route::has('welogin'))
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('welogin') }}">{{ __('تسجيل الدخول') }}</a>
                        </li>
                    @endif

                    @if (Route::has('weregister'))
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('weregister') }}">{{ __('اشتراك') }}</a>
                        </li>
                    @endif
                @else
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            @elseif(count($intern)!==0)
                                <a class="dropdown-item" href="{{route("weintern.profile")}}" >
                                    Profile
                                </a>
